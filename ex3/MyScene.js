...
class MyScene extends CGFscene {
    ...
    updateAmbientLight(){
        //the last component of the ambient light is the alpha component that we don't want to change
        this.setGlobalAmbientLight(this.ambientLight,this.ambientLight,this.ambientLight,1.0);
    }
    ...
    initMaterials() {
        ...
        // Wood (low specular)
        var color = this.hexToRgbA('#643d01');

        this.woodColor = new CGFappearance(this);
        this.woodColor.setAmbient(color[0],color[1],color[2],1.0);
        this.woodColor.setDiffuse(color[0],color[1],color[2],1.0);
        this.woodColor.setSpecular(0.0, 0.0, 0.0, 1.0);
        ...
        this.materials = [this.material1, this.material2, this.material3, this.woodColor, this.customMaterial];
