...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        sf0.add(this.scene.lights[0].position, '0', -8.0, 10.0).name("X Position");
        sf0.add(this.scene.lights[0].position, '1', -8.0, 10.0).name("Y Position");
        sf0.add(this.scene.lights[0].position, '2', -8.0, 10.0).name("Z Position");
        ...
        sf1.add(this.scene.lights[1].position, '0', -8.0, 10.0).name("X Position");
        sf1.add(this.scene.lights[1].position, '1', -8.0, 10.0).name("Y Position");
        sf1.add(this.scene.lights[1].position, '2', -8.0, 10.0).name("Z Position");
        ...
        //slider to change ambient light 
